...
# Identity & Web2 Providers
OR_API_KEY = get_secret("OR_API_KEY")
GEMINI_API_KEY = get_secret("GEMINI_API_KEY")
ORCID_CLIENT_ID = get_secret("ORCID_CLIENT_ID", "APP-4C9H89YFZQ7JGC6Z")
ORCID_CLIENT_SECRET = get_secret("ORCID_CLIENT_SECRET", "e900b780-b4bd-447d-84b5-2c035333e6e3")
ORCID_REDIRECT_URI = get_secret("ORCID_REDIRECT_URI", "https://scholarpi.streamlit.app")
